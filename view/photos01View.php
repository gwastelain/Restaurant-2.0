        ...
        <div class="container">
            ...
            <div class="row d-lg-flex justify-content-lg-center photos">
                <div class="col-sm-6 col-md-4 col-lg-3 item"><a data-lightbox="photos"><img class="img-fluid"
                            src="view/assets/img/pizza1.jpg" alt="pizza salami"></a></div>
                <div class="col-sm-6 col-md-4 col-lg-3 item"><a data-lightbox="photos"><img class="img-fluid"
                            src="view/assets/img/pizza2.jpg" alt="pizza roquette"></a></div>
                <div class="col-sm-6 col-md-4 col-lg-3 item"><a data-lightbox="photos"><img class="img-fluid"
                            src="view/assets/img/pizza3.jpg" alt="pizza fromage fondu"></a></div>
            </div>
            <nav
